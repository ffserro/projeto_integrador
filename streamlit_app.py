...
st.markdown('<img src="https://s3-sa-east-1.amazonaws.com/prod-jobsite-files.kenoby.com/uploads/digitalhouse-1647868655-552x368png.png" alt="Digital House" style="display:block;margin-left:auto;margin-right:auto;margin-bottom:-50px;width:100%">', unsafe_allow_html=True)
